module Formtastic
  module DatePicker
    ...
    def datepicker_options(format, value = nil)
      datepicker_options = {:value => value.try(:strftime, format), :input_html => {:class => 'ui-datepicker-field'}}
    end
  end
end
...
Formtastic::SemanticFormBuilder.default_text_field_size = 5
...
Formtastic::SemanticFormBuilder.priority_countries = ["United Kingdom", "Ireland", "Isle of Man"]
