          ...
          base.class_eval do
            ...
            # helper_method :facebook_session
						...
						def access_token
							...
							oauth = MiniFB.oauth_access_token(ENV['FB_APP_ID'], root_url, ENV['FB_SECRET'], params[:code]) if params[:code]	
							redirect_to session_path(scope, :method => :post) if oauth
						end
...
ActionController::Base.send :include, Devise::Facebook::Controllers::Filters